  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-zinc-950 pb-12" dir={dir}>
      ...
      <main className="max-w-5xl mx-auto w-full px-4 sm:px-6 py-8 flex-1 flex flex-col justify-center">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 p-5 rounded-lg flex items-center gap-5 shadow-sm mb-8">
          <div className="w-16 h-16 rounded-lg overflow-hidden bg-slate-100 dark:bg-zinc-800 ring-1 ring-slate-200 dark:ring-zinc-700 shrink-0 relative">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase px-2 py-0.5 rounded bg-blue-50 dark:bg-blue-950/40 text-primary border border-blue-100 dark:border-blue-900/30">
            ...
            {doctor.clinicName && (
              <p className="text-[11px] text-muted-foreground mt-0.5 truncate">{doctor.clinicName}</p>
            )}
          </div>
        </div>

        {/* Two-Column split layout inspired by reference */}
        <div className="grid md:grid-cols-12 gap-8 items-start">
          
          {/* Main Review Form Card (Left/Main Column) */}
          <div className="md:col-span-7 bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 rounded-lg p-6 sm:p-8 shadow-md">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed max-w-sm text-sm">
                    {lang === "ar"
                      ? `تم إرسال تقييمك بنجاح لمساعدة د. ${doctor.name} في تقديم أفضل رعاية.`
                      : `Your review has been successfully submitted to help Dr. ${doctor.name} provide better care.`}
                  </p>
                </motion.div>
              ) : (
                <motion.div
                ...
                >
                  ...
                  {/* Comment box styled like the light blue accent bg in reference */}
                  <div>
          ...
          {/* Guidelines / Informative Column (Right Column) inspired by reference */}
          <div className="md:col-span-5 bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 rounded-lg p-6 sm:p-8 shadow-md space-y-6">
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-zinc-800 text-center">
              <p className="text-[11px] text-muted-foreground">
                ...
                <span className="font-bold text-primary">{lang === "ar" ? "مرمر" : "Marmar"}</span>
              </p>
            </div>
          </div>
